...
import { StoreToolsService } from '@module/langchain/store.tools';
import { LangfuseService } from '@module/langchain/langfuse.service';
import { PrismaService } from '@prisma/prisma.service';

@Module({
  controllers: [LangchainController],
  providers: [LangchainService, LangchainQdrantService, McpService, HrToolsService, StoreToolsService, LangfuseService, PrismaService],
})
